...
use crate::layers::{business::{shared::errors::{BusinessError, InternalDependencyError}, usecases::list_cameras::{implementation::ListCamerasUseCaseImp, interface::{CameraListItem, IListCamerasUseCase}}}, ewi::error::AppError, ewm::main_database::qc_collection::camera_qc_collection::CameraQCCollection};

#[derive(Serialize, Deserialize)]
struct CameraResultItem {
    id: String,
    name: String
}
